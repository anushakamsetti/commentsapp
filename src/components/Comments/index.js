...
return {...eachComment,isLinked: !eachComment.isLinked}
}
return eachComment
}),
}))
...
<CommentItem key={eachComment.id} commentDetails={eachComment} toggleIsLiked={this.toggleIsLiked} deleteComment={this.deleteComment} />
))
...
this.setState(prevState => ({
commentsList: [...prevState.commentsList, newCommet],
nameInput: '',
commentInput: '',
}))
}
...
<div className="app-container">
    <div className="comments-container">
        ...
        <div className="comments-inputs">
            <from className="from" onSubmit={this.onAddComment}>
